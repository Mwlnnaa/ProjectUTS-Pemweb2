      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./index.html" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">Akmal Maulana</span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
  ...
  <form class="container form-horizontal" action="proses_paramedik.php" method="POST">
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input type="text" name="telepon" class="form-control" placeholder="Masukan No Telepon..." value="<?= $row['telepon'] ?? '' ?>">
        </div>
      </div>
    ...
    <!--end::App Content-->
      ...
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="https://github.com/Mwlnnaa" class="text-decoration-none">Akmal Maulana</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
